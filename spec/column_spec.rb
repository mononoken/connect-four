...
describe Column do
  describe '#drop' do
    ...
    context 'when column already has some marks' do
      subject(:partial_column) { described_class.new(spaces: partial_template) }
    ...
    context 'when column is already full' do
      subject(:full_column) { described_class.new(spaces: full_template) }
  ...
  describe '#full?' do
    ...
    context 'when column is partially full' do
      subject(:partial_column) { described_class.new(spaces: some_discs) }
    ...
    context 'when column is full' do
      subject(:full_column) { described_class.new(spaces: all_discs) }
